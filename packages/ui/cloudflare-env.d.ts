/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface CloudflareEnv cloudflare-env.d.ts` (hash: c3ac6650ddfabd5ad8934fe8a76addb4)
// Runtime types generated with workerd@1.20250507.0 2025-03-25 nodejs_compat
declare namespace Cloudflare {
	interface Env {
		FPM_API_KEY: string;
		ALPHA_VANTAGE_KEY: string;
		NEXT_PUBLIC_MINT_AUTHORITY_KEY: string;
